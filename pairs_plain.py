...
from features import PlainPairValuePrediction, ZeeScore
from instruments import pairIds, pairInstIds, pairStartDate, pairEndDate


class PlainPairParams(TradingSystemParameters):
    def __init__(self):
        super(PlainPairParams, self).__init__()
    ...
    def getCustomFeatures(self):
        ...
        """
        return {'plain_pairs_prediction': PlainPairValuePrediction,
                'zscore': ZeeScore}
    ...
    def getInstrumentFeatureConfigDicts(self):
        ...
        pairValuePrediction = {'featureKey': 'prediction',
                               'featureId': 'plain_pairs_prediction',
                               'params': {}}
    ...
    def getMarketFeatureConfigDicts(self):
        ...
        return [ratio1Dict, ma11Dict, ma21Dict, sdev1Dict, correl1Dict, zscore1Dict,
                ratio2Dict, ma12Dict, ma22Dict, sdev2Dict, correl2Dict, zscore2Dict]
