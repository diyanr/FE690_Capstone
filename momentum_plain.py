...
from features import PlainMomentumPrediction, FeesCalculator, BuyHoldPnL, ScoreFeature
from instruments import momInstIds, momStartDate, momEndDate


class PlainMomParams(TradingSystemParameters):

    def __init__(self):
        super(PlainMomParams, self).__init__()
        self.__dataSetId = 'equity_data'
        self.__instrumentIds = momInstIds
        self.__startDate = momStartDate
        self.__endDate = momEndDate
    ...
    def getCustomFeatures(self):
        ...
        """
        return {
            'plain_momentum_prediction': PlainMomentumPrediction,
    ...
    def getInstrumentFeatureConfigDicts(self):
        ...
        predictionDict = {
            ...
            'featureId': 'plain_momentum_prediction',
            'params': {}
        }
        feesConfigDict = {
            'featureKey': 'fees',
